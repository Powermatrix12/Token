...
async def start_command(client: Client, message: Message):
    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            SD = await message.reply_text("Baka! Files will be deleted After 24 hrs. Save them to the Saved Message now!")
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                btn = [
                    [InlineKeyboardButton("• ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ʀᴇғʀᴇsʜ ᴛᴏᴋᴇɴ •", url=link)],
                    [InlineKeyboardButton('• 🗳️ᴛᴜᴛᴏʀɪᴀʟ🗳️ •', url=TUT_VID)]
                ]
